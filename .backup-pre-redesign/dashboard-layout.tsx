  ...
  return (
    <>
      <div className="pb-4 mb-2">
        <h1 className="text-4xl font-bold text-primary tracking-tight">Dragica</h1>
      ...
      <div className="pt-4 border-t border-sidebar-border">
        <form action="/api/auth/signout" method="POST">
          <Button variant="ghost" className="w-full justify-start h-12 text-base text-secondary-foreground hover:text-white" type="submit">
...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen flex bg-background">
      {/* Desktop Sidebar */}
      <aside className="hidden md:flex w-72 bg-background border-r border-sidebar-border flex-col p-5">
