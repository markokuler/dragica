  ...
  return (
    <>
      ...
      <div className="pb-4 mb-2">
        <h1 className="text-4xl font-bold text-primary tracking-wide font-serif italic">Dragica</h1>
        <p className="text-sm text-muted-foreground tracking-wide">Tvoja pomoćnica</p>
          ...
          return (
            <Link key={item.href} href={item.href} onClick={onNavClick}>
              <Button
                variant="ghost"
                className={cn(
                  "w-full justify-start h-12 text-base transition-all duration-200 rounded-xl",
                  isActive
      ...
      <div className="pt-2">
        <form action="/api/auth/signout" method="POST">
          <Button variant="ghost" className="w-full justify-start h-12 text-base text-secondary-foreground hover:text-primary rounded-xl" type="submit">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="md:hidden flex items-center h-[72px] px-4 border-b border-border bg-card text-foreground gap-3 flex-shrink-0">
          ...
          <div className="min-w-0">
            <h1 className="text-3xl font-bold text-primary tracking-wide font-serif italic">Dragica</h1>
            <p className="text-sm text-muted-foreground">Tvoja pomoćnica</p>
          </div>
        </header>
