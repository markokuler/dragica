  ...
  return (
    <>
      ...
      <div className="pb-4 mb-2">
        ...
        {/* Natural leaf-inspired decorative element */}
      ...
      <div className="pt-2">
        <form action="/api/auth/signout" method="POST">
          <Button variant="ghost" className="w-full justify-start h-12 text-base text-muted-foreground hover:text-primary" type="submit">
