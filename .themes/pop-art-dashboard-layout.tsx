    ...
    <>
      ...
      <div className="pb-6 mb-4">
        <div className="flex items-center gap-3">
          ...
          <div className="w-14 h-14 rounded-xl bg-white border-3 border-foreground flex items-center justify-center shadow-[4px_4px_0px_#1A1A2E] relative overflow-visible">
            {/* Main coffee cup */}
            <Coffee className="w-6 h-6 text-primary" />
            {/* Calendar with check - work being done */}
            <div className="absolute -top-2 -right-2 w-7 h-7 rounded-md bg-success border-2 border-foreground flex items-center justify-center shadow-[2px_2px_0px_#1A1A2E]">
            ...
            <Link key={item.href} href={item.href} onClick={onNavClick}>
              <Button
                ...
                className={cn(
                  ...
                  isActive
                    ? "bg-white text-primary border-2 border-foreground shadow-[3px_3px_0px_#1A1A2E]"
                    : "text-foreground/80 hover:text-foreground hover:bg-white/50 hover:shadow-[2px_2px_0px_#1A1A2E] border-2 border-transparent hover:border-foreground"
                )}
              >
        ...
        <header className="md:hidden flex items-center h-16 px-4 border-b-3 border-foreground bg-sidebar text-foreground gap-3 flex-shrink-0 sticky top-0 z-50">
          <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
            <SheetTrigger asChild>
              <Button variant="ghost" size="icon" className="hover:bg-white/30 border-2 border-foreground shadow-[2px_2px_0px_#1A1A2E]">
          ...
          <div className="flex items-center gap-2 min-w-0">
            {/* Mobile Logo */}
            <div className="w-10 h-10 rounded-lg bg-white border-2 border-foreground flex items-center justify-center shadow-[2px_2px_0px_#1A1A2E] relative overflow-visible">
